...
const SideNav: React.FC = () => {
  ...
  const blobRange = [
    ...
    `M-0.5 -0.5C54.8333 -0.5 110.167 -0.5 165.5 -0.5C165.5 54.8333 165.5 110.167 165.5 165.5C164.833 165.5 164.167 165.5 163.5 165.5C138 140.5 119 151 104 144.5C89 138 100.5 118.167 83.5 111.5C66.5 104.833 46.5 111.5 32 101.5C17.5 91.5 46.5621 74.7023 38 60C32.5662 50.6695 20.5 55 17 46.5C13.5 38 24.5 13.5 1.5 2C0.905578 1.53566 0.238911 1.36899 -0.5 1.5C-0.5 0.833333 -0.5 0.166667 -0.5 -0.5Z`
  ];
